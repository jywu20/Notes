...
Here $d_k < d$ decides how much the three matrices compress the input representation matrix.
We define 
\begin{equation}
...
\end{equation}
Note that $QK^\top$ is a square matrix; the softmax function applies along its second dimension.
This is to say,
\begin{equation}
