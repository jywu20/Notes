...
the bare infinitive and the \corpus{to}-infinitive (\prettyref{sec:clause.nonfinite-clause}).
...
\begin{exe} 
    ...
    I don't appoint him, because he's my son and I don't want to leave a bad impression on my colleagues.}
\end{exe}   
...
Peripheral arguments, or simply \term{adjuncts}, 
can be distinguished from core arguments by tests described in \citet[\citechapsec{4}{1.2}]{cgel}.
