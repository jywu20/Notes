...
Although traditionally, complement clauses are regarded as \term{nominal clauses},
...
The first use of definiteness gives rise to 
...
The second use of definiteness can be seen in examples like 
...
\begin{theorybox}{The weakness of the theory of description}{theory-of-description}
