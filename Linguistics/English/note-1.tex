...
\begin{theorybox}{Negation in Cartography}{negation-position}
    ...
    The problem now is the structural position of negation 
    ...
    This phenomenon -- purely logical items in PF don't structurally infer their exact meaning in LF --
...
\begin{theorybox}{Syntactic argument structure is not exactly the semantic argument structure}{semantics-argument}
    ...
    such claims are wrong, or at least misleading.
    ...
    but \emph{not} in a one-to-one and trivial way.
\end{theorybox}
