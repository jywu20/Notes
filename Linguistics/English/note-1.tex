...
\begin{theorybox}{The exact meaning of \term{morphology}}{morphology-meaning}
    ...
    -- phonologically or syntactically -- a noun/verb/adjective/\dots{} stem.
...
at the end of a clause (\prettyref{ex:overview.adverb-2}), 
...
\begin{exe}
    ...
    \ex\label{ex:overview.adverb-4} He has [smartly] answered the question.
\end{exe}
...
though arguably, some post-internal complement adverbials 
