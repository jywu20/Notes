...
clausal dependents can be roughly divided into arguments (or ``complements'') and adjuncts.
...
Prototypical core semantic roles, like agent, patient, theme, etc. 
are always clausal complements and never adjuncts.
(The passive \corpus{by}-phrase is also an argument, not an adjunct (TODO: ref).)
