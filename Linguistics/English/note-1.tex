...
see \prettyref{chap:np} and \prettyref{chap:simple-clause}.
...
\begin{exe}
    \ex\label{ex:clause-combine.relative-question} \begin{xlist}
        \ex {} [In you opinion]_{\text{topic}}, [what] is our most urgent task right now?
        \ex {} [[What], [in his opinion]_{\text{topic}}, is our most urgent task right now]_{\text{relative}} still remains unknown for the listeners.
    \end{xlist}
\end{exe}
