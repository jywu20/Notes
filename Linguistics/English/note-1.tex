...
\subsubsection{Semantics has ``side effects'' and is related to pragmatics}
...
Therefore I roughly follow the structure of, say, \citet{Friesen2017},
...
I find this scheme beneficial for both the writer and the readers.

It's possible to change the narrative order.
When deciding the 
this note takes the strategy in \citet{jacques2021grammar}
and divide the grammar to the nominal part, 
the verbal part,
and the clause embedding part.
...
or according to the strict nominal-verbal distinction.
\citet{cgel} gives a separate chapter to adjectives and adverbs.
%Enumerating: listing variations
