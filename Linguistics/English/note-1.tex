...
Roots are presented as the simplest categorized form of them.
...
Discussion on parts of speech is therefore always about word classification,
and not abstract feature structures.
There are still structures larger than the usual concept of ``words'' 
with established meanings or even non-standard realization
...
The most frequently seen part of speech labels are noun, verb, and adjective;
how these abstract labels are realized in English needs argumentation (\prettyref{box:pos}).
...
The class of \concept{uncountable nouns} can be 

\subsection{Derivational devices}

This section only covers derivational processes.
But what is derivation, as opposed to inflection?
...
the parameter of structure size, 
and the parameter of fossilization.
...
And indeed, \citet{jacques2021grammar} calls valency changing \term{derivation}.
