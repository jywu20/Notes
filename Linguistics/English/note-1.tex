...
\begin{itemize}
    ...
    \end{itemize}
    The encoding time has no grammatical significance.
    When the decoding time is the ``suppose we are in this case'' time,
    we say the S time is \concept{deictic},
    because it refers to a time that the  stands at and is referring to. 
