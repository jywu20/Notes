...
\section{Tense and aspect meanings of verb inflection}
...
\begin{itemize}
    ...
    The relation between the two parameters TODO: phase of activity, or the perfective/imperfective distinction?
    \item R, the ``time of reference'', and the time referred to by S, as well as the orientation time of E. TODO
\end{itemize}

\begin{infobox}{Multiple times referred to and times of orientation?}{cgel-tense-def}
...
\subsubsection{Infinitive appearing in \acs{vp}}

Infinitive clauses in the \acs{vp},
on the other hand, 
have much richer behaviors.
All post-verbal infinitive clause constructions share the same surface constituent order 
shown in \prettyref{fig:complement.infinitive.template},
where the object position may be absent.
...
\subsubsection{Semantic classification of in-\acs{vp} infinitives}
