...
\section{The organization of this work}
...
\chapter{Parts of speech and derivational morphology}\label{chap:nouns}
...
The structures of the extended phrases of nouns and verbs are however too complicated 
...
I will still outline the three steps in \prettyref{sec:valency.overview}.

\subsection{The S, A, P, G, T labels}

The typological literature largely uses the generalized argument labels -- the S, A, P, G, T, etc. labels
...
\begin{theorybox}{Surface S, A, P labels as A positions}{a-position}
    This coherence between coarse-grained syntactic semantic positions 
    and clausal dependent positions has a generative root:
    The S, A, O positions may be thought of as rough A-positions. 
...
\begin{infobox}{Some notational issues}{patient-confusion}
    ...
    while in \citet{payne1997describing},
