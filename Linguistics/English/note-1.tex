...
there are more fine-grained structure within the nominal (TODO: ref).
...
can be classified according to two parameters:
whether it's a transitive preposition or a particle 
(an intransitive preposition, or something else),
and whether the construction is already an idiom
\citep[\citepage{272}]{cgel}.
