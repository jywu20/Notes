...
In a word, definiteness implies identifiablility.

The first origin of identifiablility gives rise to 
...
The second origin of identifiablility can be seen in examples like 
...
\begin{theorybox}{The weakness of the naive theory of description}{theory-of-description}
    The fact that definiteness implies identifiablility has long been noticed in the study of semantics.
...
\subsection{Nominal attributives}
