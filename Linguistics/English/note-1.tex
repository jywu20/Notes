...
\subsection{Basic Linguistic Theory from a generative perspective}
...
\subsection{Constituency-based structuralism}
...
\begin{theorybox}{Syntactic predication is not equal to semantic predication}{semantics-argument}
...
\begin{theorybox}{The semantics of content words (and their components and their phrases)}{content-word-semantics}
    ...
    a clause about an event introduces an event argument (\prettyref{box:semantics-argument}),
