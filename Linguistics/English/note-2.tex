...
\begin{theorybox}{Well-definedness of grammatical word}{grammatical-word-def}
    ...
    Some authors use the term to refer to a \emph{phase} in generative syntax,
...
\begin{theorybox}{Function words}{grammatical-words}
...
\begin{theorybox}{Subject-auxiliary inversion compared with ordinary constituent movement}{sai-status}
