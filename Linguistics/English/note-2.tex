...
\begin{table}[H]
    ...
    \midrule
    \acs{tam}-related adverbials &                                        & \cellcolor[HTML]{ECF4FF}\form{I [always] feel tired}                      \\ \midrule
    peripheral adverbials  &                                        & \form{[Frankly], I think you are fooled by them} \\ \bottomrule
    \end{tabular}}
\end{table}

\subsection{First layer: the verb phrase}
...
\begin{itemize}
    ...
    Note that manner-like arguments 
