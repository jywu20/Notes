\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
    ...
    % Text Node
    \draw (374,190) node [anchor=north west][inner sep=0.75pt]  [color={rgb, 255:red, 208; green, 63; blue, 2 }  ,opacity=1 ] [align=left] {determiner: article/demonstrative/possessive};
    % Text Node
