...
To summarize, no complement type except can be merged with another  
...
then the classification in \prettyref{sec:blt-e-argument} works,
...
and hence is placed out of the range of object.
