...
\begin{figure}
    ...
    \caption{A canonical clause is made up by a subject and a predicate}
...
\subsubsection{Tense and aspect}\label{sec:tense-aspect}

\subsubsection{Modality} \label{sec:modality}

\subsection{Non-canonical clauses without prenucleus}
...
tense and aspect (\prettyref{sec:tense-aspect}),
mood (\prettyref{sec:modality}), 
