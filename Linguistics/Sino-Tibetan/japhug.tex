...
(\prettyref{sec:grammatical.clause.internal.core-oblique}).
...
so arguments can be classified as in \prettyref{tbl:argument-classification-general}.
...
\begin{table}[H]
    ...
    \begin{itemize}
        ...
        \form{he sit [in the chair]_{\text{oblique argument}} [in this episode]_{\text{adjunct}}}.
...
are summarized in \prettyref{tbl:tame-primitives}.
...
along the line of \prettyref{tbl:argument-classification-general},
...
in \prettyref{tbl:argument-classification-general}
is the semiobject,
...
The combination of parameters in \prettyref{tbl:tame-primitives} is not trivial.
...
Now we map the combinations of the \ac{tame} values in \prettyref{tbl:tame-primitives}
