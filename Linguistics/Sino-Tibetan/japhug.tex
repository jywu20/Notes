...
\begin{itemize}
    \item The \category{primary} system, 
        ...
        This system's main exponent is stem alternation and the orientation preverb.
...
sentential adverbs (TODO: ref)
and sentence-final particles \citep[\citepage{518}]{jacques2019egophoric}.
...
\begin{itemize}
    ...
    the factual, the sensory, the egophoric, and the inferential.
    ...
    This however seems to be very infrequent in main clauses (\citepage{1087}),
    ...
    Thus, with the past tense, 
    we have a dichotomy between the generic evidentiality and the inferential evidentiality.
    
    TODO: sensory in past tense \citep[\citepage{518}]{jacques2019egophoric}
