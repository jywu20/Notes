...
\section{Clause structure}\label{sec:grammatical.simple-clause}
...
\begin{todobox}{Distinguishing a simple clause}{simple-clause-criteria}
    How to break a long sentence into simple clause segments?
\end{todobox}
...
\paragraph*{The direct-inverse system}
...
In the rest of \prettyref{sec:grammatical.simple-clause}, we describe the verb phrase.
...
\paragraph*{Internal complements} 

\begin{todobox}{Internal complements}{internal-complements}
    Definition of object, alignment, etc.
\end{todobox}

\paragraph*{\ac{tame} categories}
