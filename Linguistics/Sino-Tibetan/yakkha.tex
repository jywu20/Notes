...
\section{Clausal dependents and constituent orders}

\paragraph*{Clausal pivot, or ``subject''} It's claimed in \citet[\citepage{387}]{schackow2015grammar} that 
...
\paragraph*{(Deep) argument structures}
