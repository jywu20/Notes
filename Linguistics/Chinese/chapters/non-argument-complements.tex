...
The distributions of 来 and 去 are almost identical. % TODO: 哪里不同？

Here are some examples:
\begin{exe}
    \ex \begin{xlist}
        \ex \gll 他 回_{\text{main verb}} [来]_{\text{direction complement}} 了_{\text{\ac{sfp}}} 。 \\
        ...
        \ex \label{ex:hui-shanghai-lai-le} \gll 我 回_{\text{main verb}} 上海_{\text{object: goal}} [来]_{\text{direction complement}} 了_{\text{\ac{sfp}}}。\\ % TODO: glossing of 上海 and 了
...
the goal object of the main verb (\prettyref{sec:object-goal}), if any,
