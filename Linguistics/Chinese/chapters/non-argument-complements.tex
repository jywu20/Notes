...
of quantity complements (\prettyref{sec:quantity-complement} for more details):
\begin{exe}
    \ex \begin{xlist}
        \ex 我打了他[一下]。
        \ex 我打了他[一巴掌]。
...
by some authors \citep[Sections 7.2-7.4]{po2015chinese} or as quasi-objects by others \citep[Section 5.7]{xianhan2004}, is usually filled by a % TODO: “一个”这样的短语应该叫做什么；这里有加括号悖论，就是“一个理论”可以分解成“一个”+“理论”
