...
To throw away functional heads while keeping their functions, what we will get is \prettyref{fig:hurt-constituent-tree}. In \prettyref{fig:hurt-constituent-tree} is the syntactic tree in which 
we use the dependency relation between the left argument slot, the verb \emph{hurt} and the right 
argument slot to decide the constituency relations, and the % TODO: 说清楚这里发生了什么
