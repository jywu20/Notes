...
They are too functional to be considered as a usual complement or a modifier.
Positions that are neither complements nor modifiers include the determiner, the classifier, etc.

The functional words 
Note that whether a dependent is a complement or a modifier hints nothing about its syntactic position. 
