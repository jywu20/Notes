...
A good choice is to use the term \term{verb complex} 
...
somehow ``far'' from the lexical head (see \prettyref{sec:headedness}),
...
see \prettyref{sec:phrase-label} --
...
% TODO: 没说清楚
We may, therefore, call the notion of head in \ac{blt}, \ac{cgel} and old-fashed GB the \concept{lexical head},
while the Minimalist notion of head may be called the \concept{functional head}.
...
% clause和NP是两个大的domain
% 区分domain, layer 和constituent

A generative \term{phrase} or \term{projection}, 
therefore, corresponds to a dependency relation or grammatical system.
One or several dependency relations together form a \term{construction}
