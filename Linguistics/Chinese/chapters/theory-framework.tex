...
Note that (b) in \prettyref{fig:hurt-constituent-tree} separates \emph{syntactic function} and \emph{syntactic function}.
...
but not the coarse-grained \ac{cgel} tree (see the discussion in \prettyref{sec:sub-cat}) 
