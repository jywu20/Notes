\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-0.75,xscale=0.75]
    ...
    % Text Node
    \draw (105,154) node [anchor=north west][inner sep=0.75pt]  [color={rgb, 255:red, 0; green, 0; blue, 0 }  ,opacity=1 ] [align=left] {composite\\syntactic forms};
    % Text Node
    \draw (377.52,245.18) node   [align=left] {\begin{minipage}[lt]{76.4pt}\setlength\topsep{0pt}
    \begin{center}
    prosodic words \\that are also\\grammatical words
    \end{center}
    ...
    \end{minipage}};
    % Text Node
    \draw (304,460.93) node [anchor=north west][inner sep=0.75pt]   [align=left] {roots};
