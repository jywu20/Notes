\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-0.8,xscale=0.8]
    ...
    % Text Node
    \draw (308,212) node [anchor=north] [inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{26.5pt}\setlength\topsep{0pt}
    \begin{center}
    head:\\noun
    \end{center}
    ...
    \end{minipage}};
    % Text Node
    \draw (335,142) node [anchor=north] [inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{26.5pt}\setlength\topsep{0pt}
    \begin{center}
    head:\\noun
    \end{center}
    ...
    \end{minipage}};
    % Text Node
    \draw (227,142) node [anchor=north] [inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{27.09pt}\setlength\topsep{0pt}
    \begin{center}
    color:\\Adj
    \end{center}
    ...
    \end{minipage}};
    % Text Node
    \draw (151,75) node [anchor=north] [inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{21.45pt}\setlength\topsep{0pt}
    \begin{center}
    size:\\Adj
    \end{center}
    ...
    \end{minipage}};
    % Text Node
    \draw (215.57,44.61) node [anchor=south] [inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{100.31pt}\setlength\topsep{0pt}
    \begin{center}
    nominal
    \end{center}
