\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-0.8,xscale=0.8]
    ...
    % Text Node
    \draw (335,290) node [anchor=north] [inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{200.5pt}\setlength\topsep{0pt}
    \begin{center}
    head:\\ compound
    \end{center}
    ...
    \end{minipage}};
    % Text Node
    \draw (413.57,144.89) node [anchor=north] [inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{200.5pt}\setlength\topsep{0pt}
    \begin{center}
    head:\\compound
    \end{center}
