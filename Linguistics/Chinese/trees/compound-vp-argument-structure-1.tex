\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-0.85,xscale=0.85]
    ...
    \draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ]   (496.33,322.53) -- (496.33,389) ;
    ...
    % Text Node
    \draw (419.33,298.2) node [anchor=north] [inner sep=0.75pt]  [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,opacity=1 ] [align=left] {\begin{minipage}[lt]{100.88pt}\setlength\topsep{0pt}
    \begin{center}
    predicator\\ (\prettyref{box:dephrasal-compound})
    \end{center}
