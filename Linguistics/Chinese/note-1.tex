...
\subsubsection{Monosyllabic words}\label{sec:pos.word.monosyllabic}
...
\subsubsection{Prosodic words with questionable constituenthood}\label{sec:pos.architecture.word-confusing.constituent}
...
(essentially, by redefining what is a unit).
...
the first two being syntactic while the last class being morphological
(\citesec{2.6.1})
