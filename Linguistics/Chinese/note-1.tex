...
The most salient cases are the \corpus{bǎ}-construction (\prettyref{sec:verb-phrase.object.ba}),
...
\subsubsection{The prototypical \category{do} structure}

\subsubsection{The \category{do}-\category{affect} structure}
...
\begin{exe}
    \ex 他抢了我十块钱
    \ex \gll 我 抢 了 十 块 钱 \\
    1 rob \category{asp} ten \category{qnt} money \\
    \glt{I robbed ten dollars/\corpus{yuan}. (*I was robbed of ten dollars/\corpus{yuan}.)} 
    \ex 我被他抢了十块钱
\end{exe}
