...
\subsection{The core region: the prototypical VO form}\label{sec:simple-clause.vp.vo}
...
\begin{itemize}
    ...
    are already covered in \prettyref{chap:vp.argument}. 
...
The most salient cases are the disposal construction (\prettyref{sec:verb-phrase.object.ba}),
the \form{bèi}-constructions 
(\prettyref{sec:verb-phrase.object.short-bei}, 
\prettyref{sec:verb-phrase.bei}),
