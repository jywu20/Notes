...
\begin{theorybox}{The difference between the frameworks}{frameworks}
    ...
    the label ``subject'' can be read directly from the (more complicated) tree structure.
    ...
    and second,
    it's often argued that the seemingly direct ,
    which also agrees with Dixon's ideas in \citet{dixon2009basic} 
    that the same semantic concept may be coded quite differently. 
