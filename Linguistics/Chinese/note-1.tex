...
thus, the transitivity alternation seen in \prettyref{sec:verb-phrase.cause-become.ordinary}
is replicated in 
...
\begin{exe}
    \ex\label{ex:verb-phrase.cause.experience.alternation}  \begin{xlist}
        ...
        \gll [这 本 书]_{\text{subject,\category{become}}} [给 了]_{\text{verbal complex}} [我]_{\text{internal}} \\
...
since it's impossible to recast (\prettyref{ex:verb-phrase.cause.experience.alternation})
