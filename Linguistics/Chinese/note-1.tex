...
The main issues of recognizing prosodic words
that are also morphosyntactic units 
as grammatical words are the follows: 
\begin{itemize}
...
My proposal is to accept the morphosyntactic prosodic word 
as the definition of the grammatical word in Mandarin.
...
Recognizing the verbal complex as a word is also consistent with 
the common practice in other world languages
(\prettyref{sec:pos.architecture.word-confusing.constituent}).
