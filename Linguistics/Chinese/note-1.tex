...
The word 例如 \translate{an example is like \dots}
...
a suffix in a long grammatical word can be a phonological word (TODO: Basque example?), 
...
It should be noted that some verb ionization examples 
...
Prototypical verb ionization seems to be restricted 
to semi-objects (TODO: ref) 理了三次发. 
