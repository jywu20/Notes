...
Small variances within the broad term \term{Mandarin} exist. 
...
(or ``Basic Linguistic Theory'' (BLT); \citealt{dixon2009basic}) 
are mainly notational from a descriptive perspective.
...
I only want to point out that criteria used traditionally 
to draw a hard boundary between words and phrases 
are more or less deficient even for English \citep{bruening2018lexicalist},
...
\form{[-ed [explore \emph{something}]_{\text{argument structure}}]_{\text{\acs{tame} marking}}},
...
\subsection{The existence of words}\label{sec:pos.word}
...
\subsection{The \category{do}-\category{instrument} or \category{do}-\category{place} structure}\label{sec:vp.oblique-incorporation}
