...
\begin{itemize}
    ...
    \begin{itemize}
        \item \acs{tame} auxiliaries (\prettyref{sec:vp.aux})
        and adverbials;
...
In this note only verbal complements% 
\footnote{
...
are recognized as non-argument complements;
...
\section{Semi-objects and verb ionization}
