...
\paragraph*{Experience constructions}
Some experience verbs behave like \category{become} verbs
...
Actually, certain intransitive \category{do} verbs with agent arguments
(a wannabe subject!) also have causative usages
(\ref{ex:grammatical.clause.verbal.argument.causative.synthetic.3}),
but transitive \category{do} verbs are never compatible with the synthetic causative construction
...
\subsection{Sentence final particles}\label{sec:grammatical.clause.sfp}
...
\subsection{Topicalization}\label{sec:grammatical.clause.topic}
