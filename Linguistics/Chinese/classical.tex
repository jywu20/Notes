...
They however cannot replace human-readable, interpretable comparative analyses,
...
The internal typological diversity of Trans-Himalayan languages needs discussion,
as now the typological status of Proto-Trans-Himalayan is problematic.
...
with remarkably similar personal indexation systems
...
it is highly likely that the personal indexation system originated at a quite early stage,
...
but it does not have a rather flexible syntax (see the rest of this work).
...
It is not frequent but not impossible to apply the ``passive'' construction to a causative construction
