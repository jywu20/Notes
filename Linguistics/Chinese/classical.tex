...
Certain perception verbs have developed a figurative, fossilized meaning,
...
见 therefore means \translate{in the state of regularly meeting an important figure}.

\subsubsection{Various causative constructions}\label{sec:grammatical.clause.verbal.argument-structure.causative}

\begin{todobox}{Causer definition}{define-causer}
    Define causer.
\end{todobox}
