...
\footnote{
    ...
    On the other hand, pre-Classical Old Chinese is likely not strictly monosyllabic
    according to recent reconstructions (\prettyref{sec:intro.reconstruction.phonotactics}).
}
...
\subsubsection{Reconstruction of Old Chinese}
...
and Old Chinese reconstruction is expectedly still a chaotic field with lots of controversies.
...
based on alternations of the onset \citep[\citepages{53-59}]{baxter2014old}.
...
absence of tones, roots which are not strictly monosyllabic,
...
The factors pushing Chinese on this path are of interest.
