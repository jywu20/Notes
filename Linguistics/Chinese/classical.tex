...
The most salient feature is arguably the blurry part of speech boundaries.
...
Classical Chinese is sometimes described a language without clear part of speech distinctions.
It should be noted that noun-hood and verb-hood are still clearly definable
if the two are understood as bundles of grammatical properties
(e.g. \prettyref{sec:grammatical.clause.nominal.distinction}).
Classical Chinese content words however show much more flexibility 
...
\paragraph*{Distinction between a nominal clause and a verbal clause}\label{sec:grammatical.clause.nominal.distinction}
...
The traditional way to describe this phenomenon is ``the noun is used as a verb'',
although in conventional terminology this would be a confusion between
grammatical functions (``head of \ac{np}/\ac{vp}'') 
and lexical properties that describes how a root is licensed 
in a syntactic environment and phonologically realized
(``a noun is something that usually appears as head of \ac{np} 
and when phonologically realized, a certain morphological template applies to it'').
