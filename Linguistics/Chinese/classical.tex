...
however is beyond reasonable doubt:
for example, a list of cognates and a tentative Trans-Himalayan reconstruction can be found in \citet{hill2019historical}.

Another question -- not necessarily related to typological features -- is the position of Chinese within Trans-Himalayan,
...
and adopt a \emph{Fallen leaves model}, i.e. a thorough enumeration of all genetically certain subgroups.
...
\subsubsection{On ``Trans-Himalayan typology''}
...
\footnote{
    ...
    but Old Chinese appears to be monosyllabic,
    ...
    We are cover to cover some of these aspects in \prettyref{chap:formulae}.
}
...
On the other hand, other languages in the area that do not have clear genetic relations with the Trans-Himalayan family
...
(see \prettyref{box:direct-inverse-history} for more discussions).
Another morphological device that probably has a Proto-Trans-Himalayan origin is the the \form{*s-} prefix,
which is also supported by reconstruction of Old Chinese (TODO: ref; 四声别意).
...
\begin{infobox}{Historical status of the personal agreement affixes}{direct-inverse-history}
    ...
    We may assume that we have a direct-inverse system in Sino-Tibetan.
    Or we can always argues that
    ...
    and therefore the direct-inverse system itself cannot be reconstructed to Proto-Sino-Tibetan
    and only the personal affixes can.
    As a step further, it can be argued that the personal agreement affixes
    were probably of pronominal origins, 
    and hence argue for a morphologically impoverished Proto-Sino-Tibetan,
    and thus, the great typological distance between Proto-Sino-Tibetan and Chinese is no longer that striking.

    The viewpoint listed above is critically reviewed in \citet{jacques2012agreement}.
    Although a comprehensive comparison is still lacking,
    \citeauthor{jacques2012agreement} notices that 
    (a) there exist agreement affixes in Rgyalrongic and Kiranti that appear to be cognates and yet cannot be easily explained by grammaticalization of pronouns,
    thus at least implying certain verbal morphological complexity in a common ancestor, 
    (b) the verbal conjugation paradigms in Rgyalrongic and in Kiranti are remarkably similar
    ...
    (c) Kiranti seems to retain certain residues of an inverse prefix,
...
Old Chinese is a transitional stage between its ancestor with somehow Gyalrong-like typological traits and its daughters:
the reconstructed Old Chinese has non-tonal morphemes which are not strictly monosyllabic,
and it has various affixation mechanisms \citep[\citepage{13}]{sagart1999roots},
but it does not have a rather flexible syntax, as is shown in the rest of this work.
The evolution towards a largely analytic syntax therefore had to already have started
at the Old Chinese stage.
...
A reasonable hypothesis is that it was due to language contact,
...
but the relevant populations should be there as well when Proto-Sinitic was being formed.
