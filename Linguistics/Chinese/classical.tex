...
\subsubsection{On ``Sino-Tibetan typology''}
...
\paragraph*{How Chinese acquired its typological features?}
...
but it does \emph{not} have a rather flexible word order, as is shown in the rest of this work.
...
Further, phonetic borrowing (假借, \translate{borrowing (a character originally representing one morpheme to represent another morpheme with a close sound)}) in oracle bone inscriptions
neatly fits into reconstructed Old Chinese phonology
(e.g. \citet[\citepages{115}]{baxter2014old}).
