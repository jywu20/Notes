...
A simple Classical Chinese clause can be divided into a nucleus clause plus 
...
\subsubsection{Structural template} 
...
\subsubsection{Argument structures}
...
For instance, in the nominal predicate construction (\prettyref{sec:grammatical.clause.nominal.real}),
...
(\prettyref{sec:grammatical.clause.nominal.real}),
...
\begin{todobox}{Other topicalization constructions}{topicalization-of-object-etc}
    xx者，V 之
\end{todobox}

\paragraph*{Topics v.s. subjects}

We have already shown that Classical Chinese 
...
because as is shown above, the subject can also be topicalized.
...
\begin{exe}
    \ex\label{ex:grammatical.clause.coordination.subject-vp.1} 声伯四日不食以待之，食使者，而后食
\end{exe}
