...
including its speech force (\prettyref{sec:grammatical.clause.force}) marked by sentence final particles (\prettyref{sec:grammatical.clause.sfp}),
...
\subsection{Verbal clauses}\label{sec:grammatical.clause.verbal}
...
\subsubsection{Argument and event structures}
...
while other arguments within the \ac{vp} is \emph{internal}.
...
\subsection{Speech forces}\label{sec:grammatical.clause.force}
...
\begin{todobox}{Restructing}{moving-argument-structure-section}
    The argument structure section in the grammatical overview chapter
    is already too long.
