...
Certain examples of these ``words with internal syntax'' have phrasal counterparts,
which means they are sometimes grammatical words and sometimes phrases:
\begin{exe}
    \ex 
    \begin{xlist}
        \ex 她喜欢跳舞
...
% TODO: 不需要有动宾结构也能离合；能产的动宾结构离合程度更大
