...
and I recognize it as a word instead of a phrase (\prettyref{sec:blur-line-word-phrase}).
...
exist even for those without analyzable internal structures (\prettyref{sec:splitting}).
...
As is illustrated by \prettyref{sec:blur-line-word-phrase} and \prettyref{sec:splitting},
...
(If syntactic processes in \prettyref{sec:blur-line-word-phrase} and \prettyref{sec:splitting}
