...
We may want to run wordhood tests on these lexemes.
How does the class of all lexemes compare with the class of all morphological words?
...
Indeed, lexemes can be conceived as small idioms as well:
even English allows ad hoc re-categorization of a root
(as in \form{ball me}, which means \translate{pass the ball to me} in sports),
and the fact that 吃 is lexicalized as a verb 
can be reinterpreted as 吃 appearing at the head position being idiomized.
