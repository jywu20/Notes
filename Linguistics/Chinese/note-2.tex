...
\begin{itemize}
    ...
    depending on the grammatical tradition; see \prettyref{box:lexeme-meaning} for possible confusions).
...
Its productivity is limited to colloquial roots.
...
Besides the two suffixes that have 
