...
\begin{theorybox}{Terminology: \term{dephrasal} and \term{compound}}{dephrasal-compound}
    ...
    The distinction between the two types of ``compounds'' is observed in the nominal system (e.g. \ref{ex:grammatical.np.complementation.machine}).
    ...
    and is also related to whether we should label 关 in \prettyref{fig:grammatical.clause.core-vp.compounding.1} as a root or as a verb.
...
This, of course, involves the problem of definition of ``compounding'':
...
We tentatively analyze these glued-up verb-object forms as 
verbs taking bare nouns (instead of full fledged) as objects.
First, we note that a glued-up verb-object form regularly takes no other object.
...
once 念 and 佛 are placed together, it is no longer possible for a full fledged \ac{np} object to appear.
