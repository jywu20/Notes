...
\begin{theorybox}{The term \term{verb}}{verb-definition}
    ...
    can also be any form that appears at the center of a clause and is lexicalized (\prettyref{sec:grammatical.lexicon}).
...
Therefore, 吃-in-verbal-environment -- that's to say, 吃 as a verb (\prettyref{box:verb-definition}) -- 
