...
and preferences of syntactic environments (e.g. valency) of a \concept{lexeme}%
\footnote{
...
is both stored or in other words \concept{lexicalized} in the lexicon (\prettyref{sec:grammatical.lexicon.words}, \prettyref{box:lexeme-meaning}).
...
\begin{theorybox}{The term \term{verb}}{verb-definition}
    ...
    are out of (b):
    \prettyref{box:lexeme-meaning} is an instance of not-so-regular derivation
...
But not all \form{de}-modifications are clearly relative clauses,
as some of them are unable to be predicates.
...
that there indeed exist grammatical words and parts of speech in Mandarin,
...
Productivity and lexicalization are not always correlated.
...
\subsection{Variances in boundness}
