...
念佛 (a glued-up predicator-object structure) can be used as a nominal in \prettyref{sec:grammatical.np.complementation}
...
This also seems to be the case for some glued-up predicator-object forms,
