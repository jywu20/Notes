...
as indicated at the end of \prettyref{sec:intro.theory.lexicon},
...
Specifications of the morphological profile and the preference of syntactic environments (e.g. valency) of a form
...
\begin{theorybox}{The term \term{verb}}{verb-definition}
    ...
    (commonly referred as inflection and ``regular'' (i.e. productive, and not typically lexicalized in any sense) derivation)
...
\begin{theorybox}{Terminology: \term{dephrasal} and \term{compound}}{dephrasal-compound}
    ...
    The main reason for this line between prototypical phrases and compounds 
...
\emph{directly} head major constructions like clauses and noun phrases:
lexicalization of their preferred syntactic environments is \emph{final}:
anything built upon them is built totally compositionally.
...
Here, \term{composite syntactic forms} include prototypical phrases and
...
and hence the intersection relations between \term{composite syntactic forms}
...
like 关心了 (in which 了 has its scope over the whole clause; e.g. \prettyref{fig:grammatical.clause.core-vp.verbal-complex.2}).
...
Thus we see the interaction relation between \term{presodic words that are also grammatical words}
