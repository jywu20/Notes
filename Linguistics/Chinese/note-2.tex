...
{
\small
The underlying theoretical framework of this grammar is Distributed Morphology and Cartography.
This is to say, we assume that
(a) a grammatical construction is made of a \emph{root} surrounded by a hierarchy of \emph{functional heads} (corresponding to grammatical features and categories in traditional grammar) and their specifiers (in the generative syntactic sense), and 
(b) the functional heads often follow a relatively cross-linguistically stable hierarchy,
...
(c) post-syntactic morphological and phonological operations can bring roots and functional heads together,
...
(d) the whole process is guided by the lexicon,
...
in terms of hierarchical organization of grammatical categories and their phonological realization.
We note that (a) the hierarchy

\begin{itemize}
    \item Definition of head
    \item constituency vs. dependency
    \item lexicalization: from X-bar to traditional grammar ``structures''
\end{itemize}
...
\begin{itemize}
    \item Definition of constituency
    \item Wordhood, derivation/inflection
    \item Lexicalization
\end{itemize}
...
\begin{exe}
    ...
    \gll 我 [做 完 了]_{\text{verbal complex}} 作业 \\
