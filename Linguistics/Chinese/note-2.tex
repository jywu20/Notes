...
the main verb consists of a dephrasal compound (\ref{fig:grammatical.clause.core-vp.compounding.1}),
...
and therefore 关心 can only be seen as a dephrasal compound (\prettyref{box:dephrasal-compound})
...
(\ref{fig:grammatical.clause.core-vp.compounding.1}) is not truly unusual;
...
TODO: how to analyze things like 血压计? 
