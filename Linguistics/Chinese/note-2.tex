...
If wordhood is defined as a small constituency in the sense of generative syntax,
...
in drastically different ways a priori: we first explore ``syntax within the word'',
and then move on to discuss purely morphological operations that gather formatives together to form morphological words.
