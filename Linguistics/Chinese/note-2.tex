...
We however note that certain forms, like (\ref{ex:nouns.complex-noun.dephrasal.1.a})
and (\ref{ex:nouns.complex-noun.dephrasal.1.c}),
are not acceptable as modern Modern phrases:
至 is never used as a verb now, and 

\begin{exe}
    \ex\label{ex:nouns.complex-noun.dephrasal.1} \begin{xlist}
        \ex 霜降
        \ex\label{ex:nouns.complex-noun.dephrasal.1.c} 主席
        \ex\label{ex:nouns.complex-noun.dephrasal.1.a} 冬至
    \end{xlist}
\end{exe}
