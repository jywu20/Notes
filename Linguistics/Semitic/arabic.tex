...
\subsection{Early dialects}

Certain modern dialects near the border between Yemen and Saudi Arabia
retain certain archaic features which are not even seen in Quran.
This indicates that it is probably not appropriate to take Quranic Arabic
as the shared ancestor of all substrata of modern dialects,
and hence the linguistic diversity within the Arabic language
even before the emergence of modern dialects.

Identification and classification of ancient dialects are also problematic.
We may expect that the reading traditions of Quran save certain aspects of
the Arabic dialect at Muhammad's time.
The most popular Quran reading convention is indeed very regular and widely accepted,
but likely did not correspond to any real historic dialects.
...
Historic records indicate that the oral language of the Prophet was likely some sort of Old Hijazi.
...
although, as is said TODO, features from other early dialects seem to exist.
We should expect the common ancestor of modern Arabic dialects to be 
largely consistent with the consonant text of Quran.
Such a comparison also seems to reveal that Old Hijazi and modern Arabic dialects.
