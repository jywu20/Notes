...
and there is no sub-sub-sub-section for agreement and the subject position.
Similarly, \prettyref{sec:verb-inflection-abs} can be divided into 
...
but it is already a subsubsection and cannot be further divided.
...
Otherwise it is \concept{intransitive}.
...
\begin{itemize}
    ...
    \item \emph{Passivization}: 
\end{itemize}

Subject, direct object, indirect object, and various % TODO: predicative如何命名?
