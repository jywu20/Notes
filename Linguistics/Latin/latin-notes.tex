...
\subsection{Cases (and where to find them)}\label{sec:case}
...
\subsubsection{The three verb stems}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \end{itemize}
        \item Perfect: \corpus{-i-}.
        \item Pluperfect: \corpus{-er\={a}-}.
        \item Future perfect: \corpus{-eri-}.
    \end{itemize}
...
\begin{enumerate}
    \item First find the personal ending (\prettyref{sec:personal-marking}).
...
\subsubsection{The verb \corpus{sum}}
...
\subsection{The subject-predicate division}
