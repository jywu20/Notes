...
This criterion works well in Latin, as it is in general not possible to, for example, put a root commonly heading a noun phrase into the predicator position without evidence of verbalization.
The situation on the other hand can be much more complicated for Sinitic and Semitic languages.
However, based purely on this criterion, it is not immediately easy to identify the adjective class in Latin (TODO: ref).
...
In Latin we have two sets of inflectional templates: nominal and verbal morphology (\prettyref{sec:grammatical.pos.inflection}).
...
That in Latin, forms with nominal endings regularly appear as heads of noun phrases is an indication of existence of a noun class.
In this way we also recognize a verb class, defined by endings, agreement patterns, regular appearance as heads of clauses, etc.

We can further recognize adjectives and adverbs (TODO: ref).

Some languages have form classes that deviate strongly from the usual parts of speech defined by the first criterion \citep[\citepage{372}]{siddiqi2020routledge}.
...
This is not the case in Latin and derived stems, if lexicalized, can usually be safely classified as nouns or verbs, without marked difference in grammatical properties with those of based words.
...
\subsection{Function words, closed categories}
...
In theory, grammatical forms (affixes or auxiliaries or particles) do not need to be given in a dictionary.
