...
In this way the ``functional-typological tradition'' is often of practical advantages
(but not always; \citealt{danckaert2015studying}),
as it does not intend to arrive at all and only acceptable forms of Latin.
...
This is also the case in English (TODO: CGEL).
