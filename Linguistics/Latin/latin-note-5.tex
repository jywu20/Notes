...
\subsection{Internal structures of clauses}\label{sec:grammatical.clause.overview.internal}

All types of clauses share a similar internal makeup.
At the surface level, a clause contains a (omissible) subject
...
\ac{tam} adverbs (\prettyref{sec:grammatical.clause.tam}), and core and peripheral arguments (\prettyref{sec:grammatical.clause.argument}).

The main verb agrees with the subject.
...
Fourth, it appears that at least in some examples, standard constituency tests based on coordination, fronting, ellipsis, etc. suggest existence of a ``verb phrase'' or ``predicate'' \citep[\citepages{68-73}]{danckaert2017development}.
...
First, in Latin, in two coordinated clauses sharing a subject,
...
Second, that nonfinite clauses in Latin are either subjectless or have have an accusative clausal dependent resembling the finite clause subject
...
A third possible diagnostics for subjecthood is scope, as in interpretation of sentences like \form{every person carries a gift}.
This scope effect however is apparently not well studied in Latin.

Fourth, agreement is often related to subjecthood, though it may also be influenced by factors other than structural prominence of an argument,
...
(without any implication of hard structural differences between core and peripheral arguments;
...
it is wise to distinguish between grammatical functions (subject, object, etc.) and argument slots, with non-trivial mapping between them 
...
the semantics difference in valency alternations 
...
(c) it is the shared argument in control constructions.
...
known as the \concept{absolute use} of the verb
...
leading to S=P valency alternation.
Alternatively this can also be seen as causativization.
...
The meaning and structure of dative constructions is often quite similar to directional constructions.

Structural analysis of these constructions is controversial.
Some constructions appear to have a small clause in it 
...
Latin prepositions sometimes look like a part of the grammar, just like the morphological case.
...
\subsection{Internal makeup of noun phrases}
...
so-called directional modification adjectives,
intersective adjectives, and relative clauses.
...
as shown in the pre- or post-nominal position of arguments \citep[\citepages{326-327}]{devine2006latin}.
