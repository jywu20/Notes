...
In general, structure building processes cannot always be decisively classified as morphological or syntactic.

Besides these less specific criteria, wordhood can be relatively uncontroversially tested by criteria in \citet[\citepages{12-19}]{dixon2012basic3} divided into two groups. 
...
This process seems inactive in Latin; one potential example is \form{senatusconsultum}, which was sometimes written as a single word. 
...
Wordhood in Latin can almost solely defined via the first group of criteria,
...
Subtleties in wordhood definition mainly resolve around cliques,
...
These categories can (cross-linguistically) be roughly divided into non-aspectual categories with wider scope and aspectual categories with narrower scope.
We start with the former.

Regarding speaker-oriented categories, 
...
Now we turn to the aspectual categories.
...
First, parts of speech can be defined according to the occurrences of a form in syntactic positions (the head of a noun phrase, the predicator of a clause, etc.).
...
Second, parts of speech can be defined via (realizational) morphology.
We easily recognize two adjective classes in Japanese based on this criterion, although their syntactic distributions are largely similar.
