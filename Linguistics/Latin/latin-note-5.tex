...
We start with structural possibilities of clauses (\prettyref{sec:grammatical.clause})
...
Then, according to how forms fit into these environment,
...
A review of criteria for grammatical wordhood traditionally can be found in \citet[\citepages{12-19}]{dixon2012basic3}.
...
First, wordhood is clearly manifested when roots and grammatical formatives are brought together to form a sequence clearly motivated by anything resembling prototypical phrasal syntax.
This covers the criteria of fixed order, cohesiveness, inflection,%
\footnote{
...
because of the rich inflectional morphology.
No inconsistency is observed between this and the second group of criteria.

Furthermore, grammatical wordhood agrees with phonological wordhood almost without exception, the latter definable via stress patterns.
...
In this way, establishing wordhood of words without inflectional morphology (traditionally known as \term{particles}) based on phonological wordhood should not be controversial.
...
That Latin verbs have lexicalized \concept{argument structures} or \concept{verb frames} (\prettyref{chap:verb-frame}) is shown in TODO: ref 
...
\subsubsection{The question of configurationality}
...
Nonetheless, from the existing texts, the following phenomena seem to suggest that configurationality exists in Latin.

First, as a bare minimum, asymmetric dependency relations exist in Latin. 
This is illustrated by e.g. the distribution 

Theoretically, these dependency relations can be captured by a constituency grammar with an elaborate hierarchy of pre- and post-nucleus clause positions which constituents can be moved to.

Second, configurationality can be observed in Latin at the periphery of clauses.
TODO: \form{qui}

Third, the relative order between the negator and the auxiliary strongly suggests configurationality.

Fourth, it appears that at least in some examples, a ``verb phrase'' or ``predicate'' can be identified in Latin, by the usual constituency tests.
