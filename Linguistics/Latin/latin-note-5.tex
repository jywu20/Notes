...
This is consistent with the analysis in which 
the highest verb/auxiliary reside in a fixed position after the negator in a immobile nucleus clause,
and lower constituents and also the negator can move out of the nucleus clause to the left
...
The main difference between Latin (which now should be more accurately known as a discourse-configurational language) and languages with more rigid word order therefore can be attributed to the former having more information structural devices.
