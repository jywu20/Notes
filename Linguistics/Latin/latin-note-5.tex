...
Yet the Syntax is not formulated in predication-to-surface form pipeline as found in Simon Dik's works.%
\footnote{
    A commonly found slogan is ``we treat Latin as a system for communication.''
...
or a high-level modifier in the verbal system specifying e.g. the condition or the consequence of the main clause (subordination),%
\footnote{
...
Coordination is discussed in TODO: ref.

Regarding the internal structures, Latin clauses types are traditionally grouped into finite and non-finite ones
based on verbal morphology and subject behaviors.  

In sentential clauses, which are always finite, 
...
Coordination is marked by \form{et} or the clitic \form{=que}.
...
Subject is a grammatical function in Latin \prettyref{sec:grammatical.clause.subject}.
...
Whether there is a real need to define a direct object grammatical function is not clear. 
TODO: can it be defined solely based on passivization?
...
\subsubsection{Dative, benefactive and directional constructions}
...
and is not completely without controversies.
