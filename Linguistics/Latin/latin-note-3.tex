...
-- constituent order.
Both verbal and nominal morphology in Latin 
show clear derivation-inflection distinction:
...
Some rules are observed in inflection; TODO: productivity 

\citep[\citepages{53-58}]{oniga2014latin}
...
\begin{theorybox}{Wordhood and morphology}{wordhood}
    ...
    But this seems to be due to the fact that 
    ...
    This criterion is therefore a consequence of the first criterion above 
    ...
    ``a function word belongs to the phrase'',
    but then \acs{tame} affixes belong to the clause and not just the verb;
    this criterion is therefore sometimes about realizational morphology.
\end{theorybox}
...
\subsection{The verb template}\label{sec:verb.finite.paradigm}
...
\begin{theorybox}{A-positions}{a-position}
    ...
    \paragraph*{Ambiguity in terminology} 
    ...
    No semantic agentive argument is present,
