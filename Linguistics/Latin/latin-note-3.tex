...
The negator \corpus{non} usually appears  before the verb (TODO: or aux?),
...
\section{Distribution of the cases}

\subsection{The accusative}\label{sec:accusative-distribution}

\subsection{The dative}
...
where \corpus{this} can represent an event 
...
their internal structures (\acs{np} or clause, etc.).
...
\section{Peripheral arguments and adjuncts}
...
\subsubsection{The verb \corpus{sum}}\label{sec:sum}
