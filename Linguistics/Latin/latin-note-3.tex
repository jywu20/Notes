...
\section{Morphophonological rules}
...
\begin{infobox}{Wordhood}{wordhood}
    ...
    \paragraph*{Three definitions of wordhood} The three aspects are: 
    ...
    (and therefore doesn't provide additional information about the grammar).
\end{infobox}
...
Although traditional the genitive case is considered 
to mark the possessor, 
a complete overview of its distribution reveals that 
it's actually a structural case 
representing any type of nominal dependency 
...
(\form{a man of great talent}, \form{it's so kind of you}).
