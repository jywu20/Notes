...
\subsection{Principal forms and stems}
...
\begin{enumerate*}
    ...
    \item Primary-B, which are semantically \concept{complement-taking} and \concept{lexical},
...
\begin{theorybox}{Syntax, semantics, and the interface}{verb-syntax-semantics-interface}
    ...
    while an inchoative aspect not necessarily does so. (? or never do so? TODO)
\end{theorybox}
...
\subsubsection{Clausal dependents}
