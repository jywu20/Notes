...
and not the surrounding \acs{np}/clause (\prettyref{box:wordhood})
are morphologically realized strictly 
before prototypical inflection processes,
forming the stem 
(\prettyref{sec:noun.paradigm.introduction},
\prettyref{sec:verb.finite.paradigm}, 
\prettyref{box:stem}) to which 
...
\subsection{The paradigms}\label{sec:noun.paradigm.introduction}
...
A long vowel is shortened before \form{-m}, \form{-r}, \form{-t}, \form{-nt}, \form{-ntur},
due to vowel shortening (\prettyref{sec:phonology.rule.shortening}).
...
\begin{table}[H]
    ...
    \begin{tabular}{lll}
        ...
        \form{-b\={a}-}     & Imperfect indicative      & Possibly shortened \\
        \form{-be-}         & Future indicative         & Allomorphs: \form{-b-}, \form{-bi-}, \form{-bu-} 
        (\prettyref{sec:verb-morphology.1c}) \\
        \midrule
        $\emptyset$         & Perfect indicative        & With its own personal endings \\ 
        \form{-er\={a}-}    & Pluperfect indicative     & Possibly shortened \\
        \form{-eri-}        & Future perfect indicative & Allomorph: \form{-er-} (1sg) \\ 
        \midrule
...
\begin{itemize}
    \item The indicative:
    \begin{itemize}
        \item Present: zero suffixation, but there is :
        \begin{itemize}
...
\subsection{Peculiarities of conjugations}

\subsubsection{The first conjugation}\label{sec:verb-morphology.1c}
...
\concept{Deponent verbs} are verbs that are morphological in the passive voice 
(or syntactically, considering they are in the periphrastic passive voice
when in the perfect aspect)
...
In this section I discuss observed patterns in constituent orders.
The relevant pragmatic parameters are topic and focus, 
