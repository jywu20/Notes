...
\begin{itemize}
    ...
    \item How the above is realized: 
        ...
        This is why contemporary generative syntax gradually parts from transformation rules,
        the latter however still being a valuable concept in linguistic descriptions.
    \item A dictionary, 
...
\begin{figure}[H]
    ...
    in theory we only need concepts depicted by solid arrows,
    but sometimes for convenience we need concepts depicted by dashed arrows.}
