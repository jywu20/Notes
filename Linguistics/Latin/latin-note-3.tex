...
but there are several examples of the link between constituent order and dependency relations.
...
therefore, the mechanism of seemingly free Latin constituent order
is similar to English poetry 
...
\citet[\citepage{79}]{devine2006latin},
...
TODO: neutral order, right branching: 
this means the auxiliary by default appears between the subject 
and the \acs{vp}? subject + \form{est} + object + verb
Actually it's subject + object + verb + \form{est}
