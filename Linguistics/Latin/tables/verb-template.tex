\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
    ...
    % Text Node
    \draw (275,53.24) node  [color={rgb, 255:red, 144; green, 19; blue, 254 }  ,opacity=1 ] [align=left] {preverb};
    % Text Node
    \draw (248.01,99.24) node  [color={rgb, 255:red, 144; green, 19; blue, 254 }  ,opacity=1 ] [align=left] {root and suffixes};
    % Text Node
