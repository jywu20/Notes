...
\subsection{The ``basic'' correlatives}
...
\begin{itemize}
    ...
    \item What starts with \form{ali-} or \form{alter-} is an ``other'' pronoun.
    \item What \emph{ends} with \form{-dem} and starts with a third person pronoun
        is an identity pronoun. For example \form{īdem}. 
...
The present active participle is almost never used in  
