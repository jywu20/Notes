...
Unlike the case in morphologically more analytic languages like English,
in Latin there is no preposition that has strong interaction with the rest of the grammar 
and hence may be seen as a case particle 
(c.f. English \form{of} used to introduce the object in nominalization 
and \form{by} used to introduce the deep A argument in passivization):
all such markers for grammatical functions are realized by nominal inflection.
