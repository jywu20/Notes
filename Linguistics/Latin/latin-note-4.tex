...
in which there is no distinction between long and short \form{i},
...
These texts suggest that the language being written down into non-literary texts
was largely uniform across the whole Empire,
because deviations from the classical standard are attested universally,
and the homogeneity cannot be solely explained by formulaic texts
\citep[\citepage{235}]{clackson2011blackwell}.
The homogeneous variety underlying these ``mistakes'' seems to
be consistent with the aforementioned proto-Romance:
neutralization of long and short \form{i} is indeed constantly observed in these texts
...
Also, although we now have texts proving that 
...
these texts are strictly not truly ``Vulgar Latin texts'',
because Romans did not have field linguists,
and all ``Vulgar Latin texts'' inevitably have both Classical and Vulgar traits
\citep[\citepage{8}]{herman2010vulgar}.
...
indeed, in English \form{have/had been doing},
the imperfective feature strongly implies that the situation continues to the reference time. 
