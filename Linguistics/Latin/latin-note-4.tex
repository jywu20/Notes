...
(\prettyref{sec:grammatical.np.determiner}) and the inner parts,
...
Modifiers surrounding the core argument structure
that are ``direct modifications'' and structurally close to the head noun modify it as a whole,
just like clausal peripheral arguments and lexical aspect do,
and are semantically non-restrictive
and more about eternal properties of the things referred to,
while structurally higher modifiers restrict the reference of the noun phrase,
...
note that subtleties about the meaning of \term{predicative}
may exist depending on the type of the modifier),
and may semantically be intersective.%
\footnote{
