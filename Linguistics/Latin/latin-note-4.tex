...
\paragraph*{The road to standardization}
...
and got some sort of independence from the Greeks:
...
Cicero was equally Classical in his popular oratory and in his other works,
...
This factor however can only explain the \emph{absence} of Latin 
This however is by no means the only factor relevant,
because we can also observe a \emph{positive} correlation 
