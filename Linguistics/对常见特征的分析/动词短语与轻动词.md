...
首先回顾以下（广义的，可以把T什么的都包含进去的）动词短语中有哪些functional heads：
...
- 实际上我们可以假定所有的论元都是通过某个functional head引入的

总之，对只含有施事和受事的动词性短语而言，结构大致如下：
...
实际上，以上理论已经成功地消除了在动词性短语结构中引入adjunct概念的必要性：underspecification已经提供了足够描述“optionality”的机制。
