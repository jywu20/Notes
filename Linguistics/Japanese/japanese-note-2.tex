...
The first is most components in the verb complex 
...
but either way they appear after the main verb because they are ``heads'' 
...
is real (TODO: criteria? for example, whether all suffixes are compatible with the continuative form), 
though it's subtle and many previous researches tend to ignore this 
...
an \corpus{i} is inserted.

\section{Conjugation classes}\label{sec:conjugation-class}

\subsection{Overview}\label{sec:conjugation-class-overview}
...
\begin{theorybox}{About internal morphology of conjugation suffixes}{affix-conjugation-theory}
    The inner morphology of auxiliaries 
    -- despite their status as spellout of functional heads --  
    has no correspondence in the syntactic tree.
...
also contributes to native speakers' unawareness of the inner hierarchies of the verb complex,
thus they call suffixes ``auxiliary verbs'',
and then have to invent another name for more prototypical auxiliary verbs.
