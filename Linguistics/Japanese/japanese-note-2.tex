...
\begin{theorybox}{The notion of verb complex}{verb-complex-def}
    In this note I use the term \term{verb complex} to denote the \ac{blt} verb phrase,
    ...
    is also included as a part of the verb complex.
\end{theorybox}
...
The second is most components in the verb complex 
...
and hence productive functional morphemes in the verb complex are predominantly after the main verb
...
In the verb complex, the lexical verb always comes the first,
...
In this note I call suffixes and auxiliary verbs \term{auxiliaries} for convenience.
...
\begin{theorybox}{About internal morphology of conjugation suffixes}{affix-conjugation-theory}
    ...
    The real problem is the inner morphology of auxiliaries 
    ...
    which is completely unmotivated semantically (TODO: ref).
    ...
    The rest of the forms are also to be discussed case by case (TODO: ref).
...
things are different: now the verb complex of the complement clause ends in \corpus{te},
...
\begin{figure}[H]
    ...
    \caption{Several schemes of verb complexes. (a) Templatic morphology (b) Complement clause 
    (c) Periphrastic conjugation}
...
to describe the verb complex (\prettyref{sec:verb-complex-previous}).
...
\section{Internal conjugation}\label{sec:conjugation-class}
...
we will still use the terms \term{c-stem} and \term{v-stem} for inflectional suffixes.

\subsection{The basic forms}

Now I list the 

\subsubsection{Continuative form}\label{sec:continuative-form}

The continuative form is the default form for anything that conjugates
...
The continuative form is also the historical origin of the \corpus{te}-form (\prettyref{sec:te-form}).
