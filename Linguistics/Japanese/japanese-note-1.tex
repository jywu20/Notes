...
\begin{itemize}
    ...
    \item Attributive form (連体形) TODO: it's almost the same as the dictionary form
...
I recognize that the true conjugation endings of a lexeme are not just the five or six endings listed above,
...
The continuative form of a c-stem verb is obtained by adding \corpus{-i} to the stem.
...
The continuative form of a v-stem verb is the same as the stem.
