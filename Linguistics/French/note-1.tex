...
still seem to be syntactic objects on their own (\prettyref{sec:grammatical.clause.clitic}),
...
the clause structure with the presence of the head verb but the absence of the constituent is simply not compatible with what's recorded in the lexicon (\prettyref{sec:grammatical.pos.theory}).
...
The most uncontroversial shallow grammatical function is the subject (\prettyref{sec:grammatical.clause.subject}),
...
is also a part of the lexical information (see e.g. \prettyref{sec:grammatical.clause.peripheral}).
