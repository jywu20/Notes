...
\subsubsection{Size limit in reanalysis}\label{sec:reanalysis-size-limit-phonological-word}
...
Other types of clipping seems to be due to 

It has been proposed that a phonological word containing a segment from a morphological nearby
may be passed to daughter languages as a morphological word.
This transmission may alternate the form of the root.
...
because of phonological sandhi.
...
TODO: clipping due to phonological words containing segments of morphological words;
evolution of a phonological words containing only affixes
