...
\subsection{Types of reanalysis}
...
it can be a case suffix, a grammatical word, or the emergence of a small particle like \form{etiam}.
...
We go back to the problem of the phonological size of the locus of reanalysis in TODO
...
The latter, intuitively, is not feasible, as is discussed immediately after.
...
we will notice that only type of unit \form{et} and \form{iam} can form is a phonological word,
...
It seems as if \emph{morphological} reanalysis solely targets \emph{phonological} words now.
In this section, we discuss what is the role of morphological words without phonological status.

TODO: it seems the shift of morpheme positions can only be explained in terms of morphological wordhood.
Or otherwise we should expect two morphemes in two different phonological words being swapped.
...
\begin{itemize}
    ...
    and what actually gets changed in the surface form, if any, is usually a phonological word.
    \item 
\end{itemize}
