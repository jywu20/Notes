...
\subsection{The constituency tree}\label{sec:ica-clause}
...
\subsection{The verb-complement construction and alignment of core arguments}

In \prettyref{sec:ica-clause} I intentionally avoid using terms like object 
