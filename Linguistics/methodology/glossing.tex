...
\subsection{The notion of \term{word} and the coverage of morphology}
...
the formers are grammatical markers that can be enumerated in the grammar
and it is even appreciated if they are not listed in dictionary.

\subsubsection{Words as units with conventionalized meanings}
...
Nonetheless, the term \term{word} can be useful as a language-specific descriptive concept:
.
