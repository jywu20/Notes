...
\begin{infobox}{Terminology: adjunct, adverbial, complement, arguments}{clausal-dependent}
    ...
    The nucleus clause contains clausal dependents.
    ...
    are certainly not arguments, and are included as parts of the \ac{blt} predicate 
...
\begin{infobox}{Predicate, predicator, and verb complex}{term-predicate}
    \ac{blt} and \ac{cgel} employ the term \term{predicate} in radically different ways.
