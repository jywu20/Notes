...
\subsubsection{Notion of head, complement and modifier}
...
\prettyref{sec:clause-top-down} and \prettyref{sec:np-top-down} summarize 
how to do top-down analysis.
Details of constructions that may be met are not discussed in the two sections.
They are discussed in the bottom-up sections after \prettyref{sec:np-top-down}.
...
The problem is the resulting definition often goes against with native speakers' ``common sense''.
...
the difference between functional and lexical morphemes are not recognized,
...
It does not explain why most of the time,
...
Back-formation cannot be easily explained, for example,
...
since it is unable to describe derivational morphology,
and we know there is no clear boundary between inflection and derivation. % TODO: ref
...
but cannot explain things like back-formation that implies the existence of paradigms.
...
psychological reality does not really matter 
