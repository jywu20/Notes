...
\end{equation}
如果热机可逆则取等号。我们并没有说明热机不可逆就取不到等号，但实际上热机不可逆确实取不到等号。直接对二热源热机做这个论证比较麻烦，我们这个论证留到克劳修斯不等式的有关论述处。
% TODO
...
% TODO:不可逆取不等号。一个可能的思路是证明克劳修斯不等式等价于热力学第二定律，从而
