...
我们会注意到粒子数的期望值在这里和$\hat{\rho}$似乎有某种对应关系（比较\eqref{eq:first-law-in-statistics}和\eqref{eq:independent-q-and-w}），这当然是合理的，因为近独立系统的粒子全同而彼此独立，我们可以把它们看成单个粒子的许多复制品，这样一个全同粒子系统可以看成一个单粒子系统的系综。
