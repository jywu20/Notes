...
例如对吉布斯正则系综，$-T \ln Z$给出的是吉布斯自由能$F + \pdv{V}{q}q$，而不是$F$。此时有关的热力学公式都要做修改，但这些修改是非常机械的，很容易得到。
...
% TODO:非平衡态的化学势：体系被放置在一个几乎总是平衡的热库中，要严格处理必须考虑热库的哈密顿量和热库和系统之间的输运。但对近平衡系统，把热库积掉之后就可以
