...
完全平衡态时可以使用\eqref{eq:correlation-function-from-partition-function}把所有量都计算出来，但现在要计算的东西涉及时间演化，因此不能够简单地使用这个公式。
...
\footnote{费米场的场算符没有本征值，但总是可以找到一些特殊的算符$\theta$，用这些算符来标记态矢量，使得
\[
