...
\begin{equation}
    \begin{aligned}
        ...
        &= \frac{1}{\hbar} \sum_p \frac{\vb*{\mu}_{mg} \cdot \vb*{E}(\omega_g)}{\omega_{mg} - \omega_p} \ee^{\ii (\omega_{mg} - \omega_p) t},
    \end{aligned}
\end{equation}
双光子吸收过程为%
\footnote{
...
\begin{equation}
    \begin{aligned}
        ...
        &= \frac{1}{\hbar^2} \sum_{p, q} \sum_m \frac{(\vb*{\mu}_{nm} \cdot \vb*{E}(\omega_q)) (\vb*{\mu}_{mg} \cdot \vb*{E}(\omega_g))}{(\omega_{ng} - \omega_q - \omega_p) (\omega_{mg} - \omega_p)} \ee^{\ii (\omega_{ng} - \omega_p - \omega_q) t},
    \end{aligned}
\end{equation}
同理还能够得到三光子吸收过程
\begin{equation}
    \begin{aligned}
        &\quad \begin{gathered}
            ...
            \end{tikzpicture}
        \end{gathered} \\
        &= \frac{1}{\hbar^3} \sum_{p, q, r} \sum_{m, n} \frac{(\vb*{\mu}_{ln} \cdot \vb*{E}(\omega_r)) (\vb*{\mu}_{nm} \cdot \vb*{E}(\omega_q)) (\vb*{\mu}_{mg} \cdot \vb*{E}(\omega_g))}{(\omega_{lg} - \omega_p - \omega_q - \omega_r) (\omega_{ng} - \omega_q - \omega_p) (\omega_{mg} - \omega_p)} \ee^{\ii (\omega_{lg} - \omega_p - \omega_q - \omega_r) t}.
    \end{aligned}
\end{equation}
