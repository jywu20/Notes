...
这是因为对自由电子气系统，我们可以浸染地将相互作用加入，如果相互作用强度较小，这只会带来电子地自能修正，这样的近独立“电子气”称为\textbf{费米液体}。%
...
由于加入了自能修正，准粒子的自旋没有发生变化，但是质量发生了变化，且格林函数中会出现一个明显的虚部，即粒子寿命有限。
...
经典相变：对称性自发破缺、序参量，序参量在相变时从恒为零变得不为零
