...
设
\begin{equation}
    f_k(\theta, \varphi) = - \frac{m L^3}{2\pi \hbar^2} \frac{\ee^{\ii k r}}{r} \mel{k \hat{\vb*{r}}}{\hat{T}}{\vb*{k}} ,
\end{equation}
...
我们假定$U$很小，从而可以使用微扰论求解\eqref{eq:scattering-eigen}。从\eqref{eq:scattering-eigen}可以得到如下积分方程
\begin{equation}
...
\]
并且在坐标表象下写出了分量。\eqref{eq:born-eq}可以微扰计算，即
\[
    \begin{aligned}
