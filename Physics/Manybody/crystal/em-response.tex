...
本节做如下近似：电子可以看成波包，要求它在动量空间比较局域，在实空间相对于晶格常数比较扩展，但是在宏观尺度上仍然足够局域。这通常要求原胞内的离子势没有剧烈变化（为什么？？），空间势的变化比较缓慢，从而电子的平均自由程远大于晶格常数，外场没有破坏能带，外场变化足够慢，碰撞是瞬时发生的，弱散射。 % TODO

\subsubsection{Bloch电子波包}\label{sec:bloch-wave-pocket}
...
以上推导也说明了一件事：外场实际上不会让电子从一个能带跃迁到另一个能带。% TODO：真的吗
