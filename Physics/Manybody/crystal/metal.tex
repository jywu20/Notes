...
会让准粒子动量发生变化的那种相互作用或者说“碰撞”，正如上一节所说，需要略微远离一些费米面才看得到，没有体现在\eqref{eq:fermi-liquid-energy}中。
...
由于动理学方程实际上是电子二体格林函数的运动方程的一个近似，它给出的$n_{\vb*{k} \alpha}$如果随着时间有某种振荡模式，做完傅里叶变换就会有极点，即存在一个电子集体运动形成的元激发。
