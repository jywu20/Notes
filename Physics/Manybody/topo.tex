...
\[
    \dv{\lambda}{\ln \zeta} = \left( 2 - \frac{\beta^2}{4\pi} \right), \quad \dv{\beta}{\ln \zeta} = F \beta^3 \lambda^2,
\]
...
\begin{equation}
    \dv{\lambda}{\ln \zeta} = \left( 2 - \frac{\beta^2}{4\pi} \right), \quad \dv{\beta^2}{\ln \zeta} = A \beta^6 \lambda^2.
\end{equation}
