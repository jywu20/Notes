...
布拉维格子中的所有格点周围环境相同，每个格点对应一个原胞，无重叠无遗漏地覆盖整个空间。
...
原胞有时并不足以展示晶体的特征。\concept{晶体学原胞}或者说\concept{单胞}指的是最大限度反映晶格对称性的最小单元。
它是重复性的单元，因此它应该包含整数倍的原胞。原胞中原子位置可以使用原胞基矢，当然也可以使用单胞基矢。


\subsubsection{晶格分类}

晶格可以根据其对称性或者说所属的点群而被分类为\concept{晶系}。对二维情况，有斜方、长方、正方、六角四种晶系。
