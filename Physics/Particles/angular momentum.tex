...
\begin{document}
	...
	\begin{equation*}
		\left< J,M;\beta \left| O_{m_{1}}^{j_{1}}\right| j_{2} ,m_{2} ;\alpha \right\rangle  \varpropto C_{j_{1} j_{2} m_{1} m_{2}}^{JM}
	\end{equation*}
	...
	\begin{equation*}
		\boxed{\left< J,M;\beta \left| O_{m_{1}}^{j_{1}}\right| j_{2} ,m_{2} ;\alpha \right\rangle  =C_{j_{1} j_{2} m_{1} m_{2}}^{JM}\left< J,\beta \left| O^{j_{1}}\right| j_{2} ,\alpha \right\rangle  }
	\end{equation*}
	where $\left< J,\beta \left| O^{j_{1}}\right| j_{2} ,\alpha \right\rangle  $ is the factor that is determined by the physics. This result is the\textbf{ Wigner-Eckart} theorem of $\mathfrak{so}( 3)$ tensor operators.
	\subsection{Examples}
