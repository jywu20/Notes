...
\begin{document}
	...
	\begin{equation*}
		\left< J,M;\beta \left| O_{m_{1}}^{j_{1}}\right| j_{2} ,m_{2} ;\alpha \right> \varpropto C_{j_{1} j_{2} m_{1} m_{2}}^{JM}
	\end{equation*}
	Since $C_{j_{1} j_{2} m_{1} m_{2}}^{JM}$ is all that is determined by the group and representation theory, what remains in the matrix element $\left< J,M;\beta \left| O_{m_{1}}^{j_{1}}\right| j_{2} ,m_{2} ;\alpha \right> $ that cannot be determined by the group and representation theory should depend on the physical parameters $\alpha $ only. Thus, we conclude that
	\begin{equation*}
		\boxed{\left< J,M;\beta \left| O_{m_{1}}^{j_{1}}\right| j_{2} ,m_{2} ;\alpha \right> =C_{j_{1} j_{2} m_{1} m_{2}}^{JM}\left< J,\beta \left| O^{j_{1}}\right| j_{2} ,\alpha \right> }
	\end{equation*}
	where $\left< J,\beta \left| O^{j_{1}}\right| j_{2} ,\alpha \right> $ is the factor that is determined by the physics. This result is the\textbf{ Wigner-Eckart} theorem of $\mathfrak{so}( 3)$ tensor operators.
	\subsection{Examples}
