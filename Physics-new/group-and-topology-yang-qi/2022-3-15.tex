...
\subsection{Generic central extensions and their equivalence relations}

Now we want to investigate a generic central extension. Given an action of $Q$ on $N$, the multiplication rule is 
\begin{equation}
...
When we do spacial rotation, the spins translate as well. This results in 
