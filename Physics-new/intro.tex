...
when the universe is infinite (this can also be seen considering that we need to replace a discrete sum of possible momenta into a continuous one to get a well-defined and smooth imaginary part - the latter is a system with infinite degrees of freedom) or comes from the fact that the decay products are observed by the environment and therefore hidden non-unitary properties exist in our theory.
