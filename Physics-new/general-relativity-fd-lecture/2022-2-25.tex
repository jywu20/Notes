...
is by \prettyref{fig:comparing-element}, and the trajectory of the light signal, in general relativity,
...
\prettyref{fig:comparing-element}, and therefore $\dd{t_\text{space}} = \dd{t_\text{ground}}$, so 
\begin{equation}
