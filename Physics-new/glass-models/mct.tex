...
where we have 
\begin{equation}
    \vb{C}(t) = \expval*{\vb{A}^\dagger(0) \vb{A}(t)} = \pmqty{\left\langle\delta \rho_{-\vb*{q}}(0) \delta \rho_{\vb*{q}}(t)\right\rangle & \left\langle\delta \rho_{-\vb*{q}} j_{\vb*{q}}^\text{L}(t)\right\rangle \\
