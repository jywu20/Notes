...
We can see the derivation above has some mean-field theoretical flavor. It can be seen as a mean-field theory 
of something like a replica theory \cite{Franz_2012}. To be exact,
