...
One way to eschew this problem is to measure the ``phase''. We construct a Mach-Zehnder interferometer shown in \prettyref{fig:mach-zehnder}.
...
To go beyond the standard quantum limit we can make use of the 
