...
Now we consider a $\Lambda$-type three-level system shown in \prettyref{fig:lambda-system}.
...
system, two excited states may jump to one ground state, which may create some subtlety. % TODO

For the system in \prettyref{fig:lambda-system}, suppose there is no quantum jump before $t = t_0$, and we have 
\begin{equation}
