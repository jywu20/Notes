...
\footnote{
    For instance, suppose $a$ is a photon in a material;
    $K \Si$ roughly speaking is the spontaneous emission going back into the photon mode
    to make up for the energy loss due to $1/\tau$,
    which can be calculated by taking the imaginary part of the photon self-energy.
    However, the material needs to be thermalized so that the spontaneous emission's spectrum can be appropriately known as (incoherent) photoluminescence.
} 
