...
\end{equation}
Here we do the Markovian approximation and assume that the dissipation term 
faithfully captures the coupling of the system with the output port.
Note that this assumption is not as strong as assuming that the bath is thermalized, 
...
TODO: imaginary part, spontaneous emission. 
