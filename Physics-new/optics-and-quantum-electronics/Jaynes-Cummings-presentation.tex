...
\begin{center}
    \begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-0.8,xscale=0.8]
        ...
        % Text Node
        \draw (74,251) node [anchor=north west][inner sep=0.75pt]   [align=left] {Effective dielectric,\\scattering};
        % Text Node
        \draw (139,51) node [anchor=north west][inner sep=0.75pt]   [align=left] {Maxwell-Langevin or atomic QME};
        % Text Node
...
Small $\kappa, \gamma, \ldots$ $\Rightarrow$ closed-system cavity QED
