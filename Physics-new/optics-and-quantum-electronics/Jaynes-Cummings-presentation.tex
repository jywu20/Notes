...
\begin{frame}
\frametitle{When do all approximate theories fail? }
...
\begin{frame}
\frametitle{High coherence in cavity QED}
...
\textbf{Strong coupling limit} $\kappa, \gamma \ll {\vb*{d} \cdot \vb*{E}_{\text{cavity}}}$ $\Rightarrow$ high coherence 
