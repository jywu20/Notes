...
% Text Node
\draw (89.31,78.5) node [anchor=north] [inner sep=0.75pt]    {$\boldsymbol{q}, \omega'$};
% Text Node
\draw (150.67,69.01) node [anchor=west] [inner sep=0.75pt]    {$n'\boldsymbol{k}, \omega$};
% Text Node
\draw (22.5,69) node [anchor=east] [inner sep=0.75pt]    {$n\boldsymbol{k}, \omega$};
% Text Node
