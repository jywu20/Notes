...
\begin{equation}
    H_{\text{light-matter}} = \frac{1}{2} e (\vb*{v} \cdot \vb*{A} + \vb*{A} \cdot \vb*{v}),
\end{equation}
or, when we are in radiation gauge $\div{\vb*{A}} = 0$,
\begin{equation}
...
\bibliography{gw,dft,wannier,hubbard,quasiparticle,cohsex,structure,phonon}
