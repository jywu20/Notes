...
\subsubsection{Infinitesimals}\label{sec:cond.infinitesimal}
...
\subsubsection{The direction of momentum on the interaction line}\label{sec:gw-bse.preliminaries.diagram.direction-line}
...
\subsubsection{$GW$ compared with the Hartree-Fock approximation}\label{sec:gw.hf}
...
In other words, we are doing \concept{time-dependent $GW$}.
...
we actually need to do the COHSEX approximation or something similar 
...
can be found \href{./scripts/electron-band/qe-spin-texture.jl}{here}.
...
\bibliography{gw,dft,wannier,hubbard,quasiparticle,cohsex,structure}
