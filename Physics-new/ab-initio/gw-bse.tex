...
we have to sum over all of them to find the rate of electron being driven out.
...
$K(\omega)$ is roughly a constant.
In the terms from the poles of the BSE kernel, 

TODO: why the frequency-dependent BSE kernel in \cite{rohlfing2000electron} 
takes such a form???
