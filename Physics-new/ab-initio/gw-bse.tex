...
TODO: the problem is, the amount of energy on the interaction line 
is actually \emph{arbitrary} -- 
so why do we need things like 
\begin{equation}
    \Sigma(1, 2) = \ii G(1, 2) W(1^+, 2).
\end{equation}
TODO: to make sense of this expression, 
it's necessary to find a discussion on the self-energy of a free-electron system
...
\subsection{The $\epsilon$ matrix}\label{sec:gw-bse.overview-gw.epsilon}
...
TODO: the next question is, where does this factor come from?
...
\bibliography{gw,dft,wannier,hubbard,quasiparticle}
