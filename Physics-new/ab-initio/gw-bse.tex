...
\subsubsection{The $\epsilon$ matrix}
...
\begin{equation}
    \begin{aligned}
        ...
        &\quad \quad \times M_{n n' } (\vb*{k}, \vb*{q}, \vb*{G}) M_{nn' \vb*{G}'} (\vb*{k}, \vb*{q}, \vb*{G}') ,
    \end{aligned}
\end{equation}
...
\subsection{Getting tight-binding models}
...
\subsection{\shortcode{w90_wannier90_readwrite_read: mismatch in WTe2.eig}}
