...
$M_{n n'} (\vb*{k}, \vb*{q}, \vb*{G}) M^*_{nn'} (\vb*{k}, \vb*{q}, \vb*{G}')$ 
factor (Einstein summation convention is used): 
\begin{equation}
    \begin{aligned}
        &\quad M_{n n'} (\vb*{k}, \vb*{q}, \vb*{G}) M^*_{nn'} (\vb*{k}, \vb*{q}, \vb*{G}') \\
        &= \int \dd[3]{\vb*{r}} 
...
\end{equation}
Here that all $\psi_{m \vb*{k}}$ states 
are in the same degeneracy space of the $\psi_{n \vb*{k}}$ state. 
