...
# It's a good idea to always keep a copy of LaTeX file 
# generated by PGFPlotsX, 
# which makes furthrer modification of the figure easier

pgfsave(output_file * ".pdf", band_axis)
pgfsave(output_file * ".tex", band_axis)
