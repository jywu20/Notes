...
The most famous quasi-probability distribution
...
\end{equation}
This means not all two-variable functions can be a Wigner function:
it cannot have too strong ``spatial resolution''.
...
and the quantum noise can also be read from the quasi-probability distribution,
