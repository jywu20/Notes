...
\footnote{
	因此初等教科书中常见的，爱因斯坦“注意到参考系的加速度相似于引力从而提出了广义相对论”的故事只是完整的故事的一半。
	前者哪怕在牛顿力学中也可以得到“解释”，它在狭义相对论中也可以被证明。
	在狭义相对论中，时间和空间都是四维闵可夫斯基时空的坐标，从而参考系的加速度是一个坐标变换，它改变了度规张量的各分量的形式。
	至此，我们都还在狭义相对论的框架中工作。
	爱因斯坦对广义相对论的贡献在于，他设想，是否\emph{所有}的引力效应——不只是均匀引力场——都可以靠调整度规张量来得到。
	这个洞察是\emph{推广了}“参考系的加速度相似于引力”的观察的。
}
...
\begin{itemize}
	...
	等效原理对时空的几何性质做了约束（也可以验证，这也是时空受到的仅有的“硬”约束）：必须是无挠的。
