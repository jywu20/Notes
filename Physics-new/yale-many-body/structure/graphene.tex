\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-0.8,xscale=0.8]
    ...
    % Text Node
    \draw (323.2,101.43) node [anchor=south] [inner sep=0.75pt]    {$\boldsymbol{i} +\hat{\boldsymbol{a}}_2$};
    % Text Node
    \draw (407.95,103.93) node [anchor=south] [inner sep=0.75pt]    {$\boldsymbol{i} +\hat{\boldsymbol{a}}_1$};
    % Text Node
