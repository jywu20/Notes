...
and in the Fock basis for the light part (labeled by $m$ and $m'$).
This appearance however is misleading:
...
Moreover, the difference between the Floquet effective Hamiltonian \eqref{eq:floquet-ham}
and conventional, ``equilibrium'' effective Hamiltonians can be observed 
by the structure of its eigenstates. 
The dimension of \eqref{eq:floquet-ham}, fully expanded into its matrix elements,
...
We call \eqref{eq:floquet-ham} the effective Hamiltonian in the \concept{extended Hilbert space}.
