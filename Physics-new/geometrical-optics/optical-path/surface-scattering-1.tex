\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
    ...
    \draw [shift={(248.15,103)}, rotate = 321.54] [fill={rgb, 255:red, 245; green, 166; blue, 35 }  ,fill opacity=1 ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- (5.93,0) -- cycle    ;
    %Straight Lines [id:da8449740519670257] 
    \draw    (204.08,75.27) -- (204.08,138) ;
    \draw [shift={(204.08,72.27)}, rotate = 90] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.04,-3.86) -- (0,0) -- (8.04,3.86) -- (5.34,0) -- cycle    ;
    %Straight Lines [id:da6387995376325981] 
    \draw [color={rgb, 255:red, 245; green, 166; blue, 35 }  ,draw opacity=1 ]   (115.17,45.27) -- (204.08,138) ;
    \draw [shift={(155.96,87.81)}, rotate = 46.2] [fill={rgb, 255:red, 245; green, 166; blue, 35 }  ,fill opacity=1 ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- (5.93,0) -- cycle    ;
    ...
    % Text Node
    \draw (204.08,69.27) node [anchor=south] [inner sep=0.75pt]    {$\vu*{n}$};
    % Text Node
    \draw (300.17,63.27) node [anchor=west] [inner sep=0.75pt]    {$\vu*{s}'$};
    % Text Node
    \draw (113.17,45.27) node [anchor=east] [inner sep=0.75pt]    {$\vu*{s}$};
    % Text Node
