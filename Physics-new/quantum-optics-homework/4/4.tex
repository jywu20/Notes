...
\begin{equation}
    \begin{aligned}
        H_\text{eff} &= - \sum_{m = \pm 1/2} \hbar \Omega \dyad*{\text{e}, m}{\text{g}, m} + \text{h.c.} - \frac{\ii \hbar}{2} \sum_{p = \sigma_+, \sigma_-, \pi} C^\dagger_p C_p \\
        &= - \sum_{m = \pm 1/2} \hbar \Omega \dyad*{\text{e}, m}{\text{g}, m} + \text{h.c.} - \frac{\ii \hbar}{2} \Gamma_\text{ge} (\dyad{\text{e}, -1/2} + \dyad{\text{e}, 1/2}).
    \end{aligned}
\end{equation}

\item[(b)] The master equation is just 
\begin{equation}
    \dot{\rho} = \frac{1}{\ii \hbar} \comm*{H_\text{eff}}{\rho} + \sum_{p = \sigma_+, \sigma_-, \pi} C^\dagger_p \rho C_p.
\end{equation}  
\end{itemize}
