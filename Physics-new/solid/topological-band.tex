...
\begin{figure}
    \centering
    \input{topological-band/hall/response.tex}
...
\begin{figure}
    \centering
    \input{topological-band/hall/hall-current.tex}
...
\begin{figure}
    \centering
    \input{topological-band/ssh/lattice.tex}
...
\begin{figure}
    ...
    \subfigure[$v=1, w= 0$，没有边界态]{
        \input{topological-band/ssh/trivial-dimer.tex} 
        \label{fig:ssh-model-trivial-limit}  
    }
    \subfigure[$w = 1, v = 0$，有边界态]{
        \input{topological-band/ssh/topological-dimer.tex}
